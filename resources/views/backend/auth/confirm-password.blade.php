                ...
                <div class="login-form-area">
                    <form class="login-form" method="POST" action="{{ route(request()->segment(1).'.login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="{{old('email')}}" class="form-control input-focus" placeholder="البريد الإلكتروني">
                        ...
                        <div class="form-group">
                                ...
                                <div class="password-field">
                                    ...
                                    <input type="password" name="password" class="form-control password-input input-focus" placeholder="كلمة المرور ">
