        ...
        <div class="container">
            ...
            <div class="login-area">
                ...
                <div class="login-form-area">
                    <form class="login-form" method="POST" action="{{ route(request()->segment(1).'.password.update') }}">
                        @csrf

                        <!-- Password Reset Token -->
                        <input type="hidden" name="token" value="{{ $request->route(request()->segment(1).'.token') }}">

                        <div class="form-group">

                            <input type="text" name="email" value="{{old('email', $request->email)}}" class="form-control input-focus" required placeholder="البريد الإلكتروني">
                        ...
                        <div class="form-group">
                                ...
                                <div class="password-field">
                                    ...
                                    <input type="password" name="password" class="form-control password-input input-focus" required placeholder="كلمة المرور ">
                        ...
                        <div class="form-group">
                                ...
                                <div class="password-field">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control password-input input-focus" required placeholder="تأكيد كلمة المرور">
                                    <div class="eye-icon"></div>

                                </div>
                        </div>
                        <button class="login-btn" type="submit">إعادة تعيين</button>
                    </form>
                </div>
                ...
                <div class="forget-password">
                    ...
                    @if (Route::has('password.request'))
                        <a class="forget-password-link" data-bs-toggle="modal" data-bs-target="#forgetPasswordmodal">
                            نسيت كلمة المرور؟   
                        </a>
                    @endif
