            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">                        
                        ...
                        <a class="add-new-item table_add_btn" href="{{route('company.operators.create')}}">
                            <span>                                    
                        ...
                        <div class="table-head">                        
                            <div class="table-search">                        
                                <div class="form-group">
                                    <form method="GET" id="search_form" action="{{route('company.operators.index')}}">
                                            ...
                                            <th>
                                                ...
                                                <!--div class="add-user-dropdown dropdown">                                                                                                
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="addDropdown">
                                                        <li><a class="dropdown-item" href="{{route('company.operators.create')}}"> إضافة مشغل جديد</a></li>                                                        
                                                    </ul>
                                                </div-->                                                  
                                            </th>
                                        </tr>
                                                ...
                                                <td>
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <li><a class="dropdown-item" href="{{route('company.operators.edit', $operator->id)}}">تعديل</a></li>
                                                            <li>
                                                                <?php
