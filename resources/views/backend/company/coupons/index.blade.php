            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">
                        ...
                        <a class="add-new-item table_add_btn" href="{{route('company.coupons.create')}}">
                            <span>                                    
                        ...
                        <div class="table-head">
                                ...
                                <div class="table-search">
                                    ...
                                    <div class="form-group">
                                        <form method="GET" id="search_form" action="{{route('company.coupons.index')}}">
                                    ...
                                    <table class="table table-borderless">
                                            ...
                                            <th>              
                                                ...
                                                <!--div class="add-user-dropdown dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="addDropdown">
                                                        <li>                                                            
                                                            <a class="dropdown-item" href="{{route('company.coupons.create')}}">
                                                                إضافة كود خصم                                                                
                                                            </a>                                                        
                                                        </li>                                                            
                                                    </ul>
                                        ...
                                        @if($coupons->count()>0)
                                            ...
                                            <tr>
                                                ...
                                                <td>                                            
                                                    <p class="td-text">{{$coupon->adder->name.' - #'.$coupon->adder->code}}</p>
                                                ...
                                                <td>                                            
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            ...
                                                            <li><a class="dropdown-item" href="{{route('company.coupons.edit', $coupon->id)}}">تعديل</a></li>
                                                            <li>
                                                                <?php
                                                                    $action = route('company.coupons.destroy', $coupon->id);
                                                                ?>
