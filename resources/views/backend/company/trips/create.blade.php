                                    ...
                                    <div class="item-wrap">
                                        ...
                                        <div class="item-box trip-box add-trip">
                                            ...
                                            <div class="item-details trip-details">
                                                ...
                                                <form class="item-details-form trip-details-form" method="POST" action="{{route('company.trips.store')}}" enctype="multipart/form-data">
                                                    @csrf
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="operator_id" class="form-select select2 {{$errors->has('operator_id') ? 'is-invalid' : ''}}" aria-label="Default select example" required>
                                                                    ...
                                                                    <option value="{{$operator->id}}" <?php if(old('operator_id')==$operator->id) { echo 'selected'; } ?>>{{$operator->name}}</option>
                                                                    @endforeach                                                                  
                                                                </select>
                                                                @error('operator_id')
