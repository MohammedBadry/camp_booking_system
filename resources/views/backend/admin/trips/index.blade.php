            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">
                        ...
                        <a class="add-new-item table_add_btn" href="{{route('admin.trips.create')}}/?type_id={{request()->get('type_id')}}">
                            <span>                                    
                        ...
                        <div class="table-head">
                                ...
                                <div class="table-search">
                                    ...
                                    <div class="form-group">
                                        <form method="GET" id="search_form" action="{{route('admin.trips.index')}}">
                                    ...
                                    <table class="table table-borderless table-xl">
                                                ...
                                                <!--div class="add-user-dropdown dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="addDropdown">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" href="{{route('admin.trips.create')}}">
                                                                    إضافة رحلة جديدة
                                        ...
                                        @if($trips->count()>0)
                                            ...
                                            <tr>
                                                ...
                                                <td>                                            
                                                    <p class="td-text">{{$trip->trip_date}}</p>                                                
                                                </td>
                                                <td>                                            
                                                    <p class="td-text">
                                                        @if($trip->status==1)
                                                ...
                                                <td>                                            
                                                    <p class="td-text">{{$trip->capacity}} شخص</p>                                                
                                                </td>
                                                <td>                                            
                                                    <p class="td-text">{{$trip->operator->name}}</p>                                                
                                                </td>
                                                <td>                                            
                                                    <p class="td-text">
                                                        <?php
                                                        if($trip->adder) {
                                                            if($trip->adder->role=="operator") {
                                                                echo "مشغل: ";
                                                            }
                                                ...
                                                <td>                                            
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            ...
                                                            <li><a class="dropdown-item" href="{{route('admin.trips.edit', $trip->id)}}/?type_id={{request()->get('type_id')}}">تعديل</a></li>
                                                            <li>
                                                                <?php
                                                                    $action = route('admin.trips.destroy', $trip->id);
                                                                ?>
                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#confirmDelatemodal" onclick="$('#confirmDelatemodal #action').val('{{$action}}'); $('#type_id').val('1')">حذف</a>
                                                            </li>
                                                        </ul>
                                                    </div>                                                
                                                </td>                                             
