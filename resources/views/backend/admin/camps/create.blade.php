                            ...
                            <div class="items-container trips-container one-trip-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="item-wrap">
                                        ...
                                        <div class="item-box trip-box add-trip">

                                            <div class="item-banner-wrap">

                                                <button type="button" id="upload-banner-btn" onclick="$('#image').click();" class="upload-banner-btn">
                                                    ...
                                                    <div class="delete-new-item" data-bs-toggle="tooltip" data-bs-placement="right" title="حذف نهائي"><i class="fas fa-trash-alt"></i></div>
                                                </button>

                                                <div class="banner-wrap" id="image_preview" style="display: none">
                                            ...
                                            <div class="duplicated-table-area add-new-banner-area d-none">

                                                     <button type="button" class="add-new-banner table_add_btn">

                                                         <span>

                                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="64px" height="64px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
                                                                <g>
                                                                <g>
                                                                <g id="circle_copy_4">
                                                                <g>
                                                                ...
                                                                C2,15.432,15.432,2,32,2c16.568,0,30,13.432,30,30C62,48.568,48.568,62.001,32,62.001z"></path>
                                                                </g>
                                                                </g>
                                                                <g id="Menu_1_">
                                                                <g>
                                                                <polygon points="44,31 33,31 33,20 31,20 31,31 20,31 20,33 31,33 31,44 33,44 33,33 44,33 				"></polygon>
                                                                </g>
                                                                </g>
                                                                </g>
                                                                </g>
                                            ...
                                            <div class="item-details trip-details">
                                                ...
                                                <form class="item-details-form trip-details-form" method="POST" action="{{route('admin.trips.store')}}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title" value="{{old('title')}}" class="form-control input-focus {{$errors->has('title') ? 'is-invalid' : ''}}" placeholder="اسم المخيم" required>
                                                                @error('title')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="size" class="form-select select2 {{$errors->has('size') ? 'is-invalid' : ''}}" aria-label="Default select example" >
                                                                    ...
                                                                    <option value="كبير" <?php if(old('size')=='كبير') { echo 'selected'; } ?>>كبير</option>
                                                                    <option value="صغير" <?php if(old('size')=='صغير') { echo 'selected'; } ?>>صغير</option>
                                                                </select>
                                                                @error('size')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="from" value="{{old('from')}}" class="form-control input-focus {{$errors->has('from') ? 'is-invalid' : ''}}" placeholder="السعة من" required>
                                                                @error('from')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="to" value="{{old('to')}}" class="form-control input-focus {{$errors->has('to') ? 'is-invalid' : ''}}" placeholder="السعة إلى" required>
                                                                @error('to')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="camps_num" value="{{old('camps_num')}}" class="form-control input-focus {{$errors->has('camps_num') ? 'is-invalid' : ''}}" placeholder="عدد المخيمات" required>
                                                                @error('camps_num')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="price" value="{{old('price')}}" class="form-control input-focus {{$errors->has('price') ? 'is-invalid' : ''}}" placeholder="السعر بالريال" required>
                                                                @error('price')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="code" value="{{old('code')}}" class="form-control input-focus {{$errors->has('code') ? 'is-invalid' : ''}}" placeholder="كود المخيم" required>
                                                                @error('code')
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="description" name="description" class="form-control input-focus {{$errors->has('description') ? 'is-invalid' : ''}}" placeholder="الوصف" required>{{old('description')}}</textarea>
                                                                @error('description')
                                                        ...
                                                        <div class="col-12">
                                                            <div class="item-details-btns">
                                                                <button type="submit" class="details-btn add-btn modify-btn">إضافة</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
