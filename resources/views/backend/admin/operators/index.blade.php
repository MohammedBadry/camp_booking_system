                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">                        
                        <div class="table-show-item">
                            الإجمالي : 
                            <span>{{$operators->count()}}</span>
                            مشغل
                        </div>
                        
                        <a class="add-new-item table_add_btn" href="{{route('admin.operators.create')}}">
                            <span>                                    
                        ...
                        <div class="table-head">                        
                            <div class="table-search">                        
                                <div class="form-group">
                                    <form method="GET" id="search_form" action="{{route('admin.operators.index')}}">
                                ...
                                <div class="table-responsive scroll draggable-table">
                                    ...
                                    <table class="table table-borderless">
                                            ...
                                            <th>
                                                ...
                                                <!--div class="add-user-dropdown dropdown">                                                                                                
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="addDropdown">
                                                        <li><a class="dropdown-item" href="{{route('admin.operators.create')}}"> إضافة مشغل جديد</a></li>                                                        
                                                    </ul>
                                                </div-->                                                  
                                            </th>
                                        </tr>
                                        ...
                                        @if($operators->count()>0)
                                            ...
                                            <tr>                                            
                                                <td>                                            
                                                    <p class="td-text">{{$operator->id}}</p>                                                
                                                </td>
                                                <td>                                            
                                                    <p class="td-text">{{$operator->name}}</p>                                                
                                                </td>
                                                <td>
                                                    <p class="td-text">{{$operator->mobile}}</p>
                                                </td>
                                                <td>
                                                    <p class="td-text">{{$operator->email}}</p>
                                                </td>
                                                <td>
                                                    <p class="td-text">{{$operator->adder->name .' - #'. $operator->adder->id}}</p>
                                                </td>
                                                <td>
                                                    <p class="td-text">{{Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $operator->created_at)->format('Y-m-d')}}</p>                                                    
                                                </td>
                                                <td>
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <li><a class="dropdown-item" href="{{route('admin.operators.edit', $operator->id)}}">تعديل</a></li>
                                                            <li>
                                                                <?php
                                                                    $action = route('admin.operators.destroy', $operator->id);
                                                                ?>
                        ...
                        <div class="table-footer">
                            ...
                            <div class="table-Pagination">
                                ...
                                <nav aria-label="table-Pagination">
                                    {{$operators->render("pagination::bootstrap-4")}}
                                </nav>
                            </div>
