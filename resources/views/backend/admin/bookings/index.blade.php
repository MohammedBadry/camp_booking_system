                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">
                        ...
                        <div class="import-style">
                             ...
                             <a class="add-new-item table_add_btn" href="{{route('admin.bookings.create')}}">
                                <span>                                    
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="terms-wrap">
                                            <form method="POST" id="import_form" action="{{route('admin.bookings.import')}}" enctype="multipart/form-data">
                                                @csrf
                        ...
                        <div class="table-head">
                                <div class="table-search">                        
                                    <div class="form-group">
                                        <form method="GET" id="search_form" action="{{route('admin.bookings.index')}}">
                                                ...
                                                <td>                                            
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <li><a class="dropdown-item show-trip" href="{{route('admin.bookings.show', $booking->id)}}">عرض</a>
                                                            <li><a class="dropdown-item" href="{{route('admin.bookings.edit', $booking->id)}}">تعديل</a></li>
                                                            <li>
                                                                <?php
