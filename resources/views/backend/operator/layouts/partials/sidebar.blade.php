<aside class="left-sidebar">
    <div class="slidebar-content">        
        <div class="logo-area">
           <a class="d-block" href="{{route('operator.dashboard')}}">
        ...
        <ul class="slidebar-links">
            <li class="sidebar-item">
                ...
                <a class="sidebar-link @if(request()->segment(2)=='dashboard') active @endif" href="{{route('operator.dashboard')}}">
                    <span>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link @if(request()->segment(2)=='bookings') active @endif" href="{{route('operator.bookings.index')}}">
                    <span>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link @if(request()->segment(2)=='trips') active @endif" href="{{route('operator.trips.index')}}">
                    <span>
