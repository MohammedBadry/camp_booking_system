...
<body>
    ...
    @include('backend.operator.layouts.partials.sidebar')
        ...
        <div class="top-nav">
            ...
            <div class="container h-100">            
                <div class="nav-content">                    
                    ...
                    @include('backend.operator.layouts.partials.navbar')
                </div>            
            </div>
    ...
    <form method="POST" id="logout_form" action="{{ route('operator.profile.logout') }}">
    @csrf
    </form>
