                                    ...
                                    <div class="item-wrap">
                                        ...
                                        <div class="item-box trip-box add-trip">
                                            ...
                                            <div class="item-details trip-details">
                                                ...
                                                <form class="item-details-form trip-details-form" method="POST" action="{{route('operator.trips.store')}}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">                                                        
                                                                ...
                                                                <input type="text" name="title" value="{{old('title')}}" class="form-control input-focus {{$errors->has('title') ? 'is-invalid' : ''}}" placeholder="عنوان الرحلة" required>
                                                                @error('title')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="capacity" value="{{old('capacity')}}" class="form-control input-focus {{$errors->has('capacity') ? 'is-invalid' : ''}}" placeholder="سعة الرحلة للاشخاص" required>
                                                                @error('capacity')
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group data-input-wrap">
                                                                ...
                                                                <div class="data-input">
                                                                    <input type="text" autocomplete="off" name="trip_date" value="{{old('trip_date')}}" class="form-control input-focus datepicker {{$errors->has('trip_date') ? 'is-invalid' : ''}}" placeholder="تاريخ الرحلة" required>
                                                        ...
                                                        <div class="col-lg-6">                                                            
                                                            <div class="form-group">
                                                                ...
                                                                <select name="status" class="form-select select2 " aria-label="Default select example" >
                                                                    <option selected disabled>نوع الرحلة </option>
                                                                    <option value="1" <?php if(old('status')==1) { echo 'selected'; } ?>>عامة</option>
                                                                    <option value="0" <?php if(old('status')===0) { echo 'selected'; } ?>>خاصة</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="category_id" class="form-select select2 {{$errors->has('category_id') ? 'is-invalid' : ''}}" aria-label="Default select example" >
                                                                    <option selected>فئة الرحلة </option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="code" value="{{old('code')}}" class="form-control input-focus {{$errors->has('code') ? 'is-invalid' : ''}}" placeholder="كود الرحلة" required>
                                                                @error('code')
