                                    ...
                                    <div class="item-wrap">
                                        ...
                                        <div class="item-box trip-box add-trip modify-style">
                                            ...
                                            <div class="item-details trip-details">
                                                ...
                                                <form class="item-details-form trip-details-form" method="POST" action="{{route('operator.trips.update', $trip->id)}}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                        ...
                                                        <div class="col-lg-6">                                                            
                                                         ...
                                                         <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="operator_id" class="form-select select2 {{$errors->has('operator_id') ? 'is-invalid' : ''}}" aria-label="Default select example" disabled required>
