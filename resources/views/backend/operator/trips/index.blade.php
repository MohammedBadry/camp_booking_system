            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="duplicated-table-area">
                        ...
                        <a class="add-new-item table_add_btn" href="{{route('operator.trips.create')}}/?type_id={{request()->get('type_id')}}">
                            <span>                                    
                        ...
                        <div class="table-head">
                                ...
                                <div class="table-search">
                                    ...
                                    <div class="form-group">
                                        <form method="GET" id="search_form" action="{{route('operator.trips.index')}}">
                                    ...
                                    <table class="table table-borderless table-xl">
                                                ...
                                                <!--div class="add-user-dropdown dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="addDropdown">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" href="{{route('operator.trips.create')}}">
                                                                    إضافة رحلة جديدة
                                        ...
                                        @if($trips->count()>0)
                                            ...
                                            <tr>
                                                ...
                                                <td>                                            
                                                    <p class="td-text">{{$trip->status==0 ? 'خاصة' : 'عامة'}}</p>                                                
                                                </td>
                                                <td>                                            
                                                ...
                                                <td>                                            
                                                    <div class="table-action dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            ...
                                                            <li><a class="dropdown-item" href="{{route('operator.trips.edit', $trip->id)}}">تعديل</a></li>
                                                            <li>
                                                                <?php
                                                                    $action = route('operator.trips.destroy', $trip->id);
                                                                ?>
